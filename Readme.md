...
La app funciona desde el navegador y también se puede **instalar como una app** (sin pasar por el App Store).
...
Para documentación técnica ver [DEVELOPMENT.md](DEVELOPMENT.md).
